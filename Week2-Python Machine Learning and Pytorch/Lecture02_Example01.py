# -*- coding: utf-8 -*-
"""
Created on Sun Jan 17 12:11:23 2021

QBUS6850 Lecture 2 Example 1
...
y_data = np.reshape(np.array(car_price), (len(car_price), 1))   # Junbin fixed an issue here, 17 Jan 2021
